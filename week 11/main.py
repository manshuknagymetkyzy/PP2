...
def game_over():
    ...
    if snake.score >snake2.score:
        my_score = font.render('Snake number 1 win Total score: ' + str(snake.score)+'-' + str(snake2.score) , True, (255, 255, 255))
    elif snake2.score > snake.score:
        my_score = font.render('Snake number 2 win Total score: ' + str(snake2.score)+'-' + str(snake.score) , True, (255, 255, 255))
    else:
