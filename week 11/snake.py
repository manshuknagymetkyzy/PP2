...
def MainMenu():
    ...
    while True:
        ...
        draw_text('New Game',font1,(192,192,192),screen,150,200)
        draw_text('Saved Game',font1,(192,192,192),screen,150,300)
        draw_text('Snake Game',pygame.font.SysFont('Lucida Handwriting',60),(255,255,255),screen,115,50)

        if button_1.collidepoint((mx,my)):
            draw_text('New Game',font1,(255,255,255),screen,160,200)
            if click :
                single()
        if button_2.collidepoint((mx,my)):
            draw_text('Saved Game',font1,(255,255,255),screen,160,300)
            if click:
               saved_game()
